(function (E, X) {
    ...
    Xa.prototype = {
        ...
        runPointActions: function (a) {
            ...
            if (e)
                for (b = j.length; b--;)(j[b].clientX !== l[1].clientX || j[b].series.noSharedTooltip) && j.splice(b, 1);
    ...
    Q.prototype = {
        ...
        getExtremes: function (a) {
            ...
            d = a.length;
            for (l = 0; l < d; l++)
                if (k = c[l], j = a[l], i = j !== null && j !== z && (!b.isLog || j.length || j > 0), k = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[l + 1] || k) >= g && (c[l - 1] || k) <= h, i && k)
                    if (i = j.length)
                ...
                o(b, function (g, i) {
                    ...
                    if (f[g] && !f[g].isNull) a.push(f[g]), o([-1, 1], function (a) {
                        var c = a === 1 ? "rightNull" : "leftNull",
                            ...
                            n = e[b[i + a]];
                        if (n)
                            for (m = h; m >= 0 && m < k;) p = n.points[m], p || (m === h ? f[g][c] = !0 : j[m] && (q = e[g].points[m]) && (d -= q[1] - q[0])), m += l;
