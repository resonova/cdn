...
CODEBOOK = (function () {
    ...
    function showErrorForLine(line) {
        ...
        if (errorString.length > 1) {
            ...
            el.style.top = editor.charCoords({
                line: line + 1,
                ch: 0
            }).y + 2 + "px";
            el.className = "";
